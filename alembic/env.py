...
1. Use the database URL from application settings
2. Import all SQLModel models for autogenerate support
...
# Add src to path so we can import policyengine_api
...
# This allows Alembic to detect changes in your SQLModel models
