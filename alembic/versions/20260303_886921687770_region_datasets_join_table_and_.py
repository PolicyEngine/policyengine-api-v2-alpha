...
def upgrade() -> None:
    ...
    op.create_table('region_datasets',
...
def downgrade() -> None:
    ...
    op.add_column('regions', sa.Column('dataset_id', sa.UUID(), autoincrement=False, nullable=True))
    ...
    op.create_foreign_key(op.f('regions_dataset_id_fkey'), 'regions', 'datasets', ['dataset_id'], ['id'])
